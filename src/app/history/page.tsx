  ...
  if (isLoading) {
    return (
      <div className="py-24 flex flex-col items-center justify-center gap-3 text-slate-400">
        ...
        <span className="text-xs font-semibold text-slate-500">Loading Reports...</span>
      </div>
    );
  }
      ...
      <div className="max-w-md mx-auto py-12 px-4 text-center space-y-6 animate-in fade-in">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
            {language === 'te'
              ? 'మీ గత పంట తనిఖీ నివేదికలను చూడటానికి దయచేసి ఖాతాలోకి లాగిన్ అవ్వండి లేదా కొత్త ఖాతా తెరవండి.'
              : language === 'hi'
              ? 'अपनी पिछली फसल जांच रिपोर्ट देखने के लिए कृपया लॉगिन करें या नया खाता बनाएं।'
              : 'Please sign in or register a free farmer account to view your past crop health reports.'}
          </p>
        </div>
